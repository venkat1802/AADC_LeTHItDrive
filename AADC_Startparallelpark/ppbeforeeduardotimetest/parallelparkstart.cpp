...
{   
    ...
    SetPropertyFloat(PP_DISTANCE_ADD1, 0.26);
    ...
    SetPropertyFloat(PP_DISTANCE_ADD2, 0.82);
    ...
    SetPropertyFloat(PP_DISTANCE_ADD3, 0.95);
    ...
    SetPropertyFloat(PP_DISTANCE_ADD4, 0.6);
    ...
    SetPropertyFloat(PP_DISTANCE_ADD5, 0.6);
