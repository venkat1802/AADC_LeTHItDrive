...
#define PP_DISTANCE_ADD21 "initPP::DISTANCE_ADD21"
#define PP_DISTANCE_ADD22 "initPP::DISTANCE_ADD22"
...
#define PP_DISTANCE_ADD8 "initPP::DISTANCE_ADD8"
...
{   
    ...
    SetPropertyFloat(PP_DISTANCE_ADD2, 0.4);
    ...
    SetPropertyFloat(PP_DISTANCE_ADD21, 0.8);
    SetPropertyBool(PP_DISTANCE_ADD21 NSSUBPROP_ISCHANGEABLE, tTrue);
    SetPropertyStr(PP_DISTANCE_ADD21 NSSUBPROP_DESCRIPTION, "stage21 add distance");

    SetPropertyFloat(PP_DISTANCE_ADD22, 0.4);
    SetPropertyBool(PP_DISTANCE_ADD22 NSSUBPROP_ISCHANGEABLE, tTrue);
    SetPropertyStr(PP_DISTANCE_ADD22 NSSUBPROP_DESCRIPTION, "stage22 add distance");
    ...
    SetPropertyFloat(PP_DISTANCE_ADD5, 0.1);
    ...
    SetPropertyFloat(PP_DISTANCE_ADD7, 0.3);
    ...
    SetPropertyFloat(PP_DISTANCE_ADD8, 0.1);
    SetPropertyBool(PP_DISTANCE_ADD8 NSSUBPROP_ISCHANGEABLE, tTrue);
    SetPropertyStr(PP_DISTANCE_ADD8 NSSUBPROP_DESCRIPTION, "stage8 add distance");
    ...
    SetPropertyFloat(PP_PARK_ACCEL_REV, 98);
    ...
    SetPropertyFloat(PP_STG6STR, 60);
    SetPropertyBool(PP_STG6STR NSSUBPROP_ISCHANGEABLE, tTrue);
    SetPropertyStr(PP_STG6STR NSSUBPROP_DESCRIPTION, "stage 6 steering angle");

    SetPropertyFloat(PP_STG7STR, 105);
    SetPropertyBool(PP_STG7STR NSSUBPROP_ISCHANGEABLE, tTrue);
    SetPropertyStr(PP_STG3STR NSSUBPROP_DESCRIPTION, "stage 7 steering angle");
...
tResult cParallelParkInit::ReadProperties(const tChar* strPropertyName)
{
    ...
    {
        distance_add1 = GetPropertyFloat(PP_DISTANCE_ADD1);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD2))
    {
        distance_add2 = GetPropertyFloat(PP_DISTANCE_ADD2);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD21))
    {
        distance_add21 = GetPropertyFloat(PP_DISTANCE_ADD21);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD22))
    {
        distance_add22 = GetPropertyFloat(PP_DISTANCE_ADD22);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD3))
    {
        distance_add3 = GetPropertyFloat(PP_DISTANCE_ADD3);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD4))
    {
        distance_add4 = GetPropertyFloat(PP_DISTANCE_ADD4);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD5))
    {
        distance_add5 = GetPropertyFloat(PP_DISTANCE_ADD5);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD6))
    {
        distance_add6 = GetPropertyFloat(PP_DISTANCE_ADD6);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD7))
    {
        distance_add7 = GetPropertyFloat(PP_DISTANCE_ADD7);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_DISTANCE_ADD8))
    {
        distance_add8 = GetPropertyFloat(PP_DISTANCE_ADD8);
    }
    ...
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_STG6STR))
    {
        stg6str = GetPropertyFloat(PP_STG6STR);
    }
    if (NULL == strPropertyName || cString::IsEqual(strPropertyName, PP_STG7STR))
    {
        stg7str = GetPropertyFloat(PP_STG7STR);
    }
...
tResult cParallelParkInit::ProcessVideo(adtf::IMediaSample* pISample)
{
    ...
    if (IS_OK(pISample->Lock(&l_pSrcBuffer)))
    {
		...
		///////////////start
    		...
    		if(!direct_flag)
		{
			mytemplate = imread("/home/aadc/AADC/src/aadcUser/src/AADC_Startparallelpark/temp_last1.jpg",CV_LOAD_IMAGE_GRAYSCALE);
			img = TheInputImage ;
			img1 = img;
			//img = img(Rect(430,290,190,30));
			img = img(Rect(460,230,180,50));
		...
		{	
			...
			case 2:
			{
				...
				else
				{
					...
					distance_scanstart = Distnce + 0.2;
					distance_scanend = distance_desired21 - 0.2;
					//maneuverfinish_flag = tTrue;
					LOG_INFO(adtf_util::cString::Format(" %d ", currentStage ));
				}
			...
			case 7:
			{
				...
				else
				{
					...
					Steerout = 90;
					currentStage = 8;
					distance_desired8 = Distnce + distance_add8;
					//SignalID = 16;
			...
			case 3:
			{
				...
				else
				{
					...
					indicatorLeft = tFalse;
					currentStage = 4;
					distance_desired4 = Distnce + 0.35;
				}
				//writeOutputs(timeStamp);
				//writeFlags(timeStamp);
				break;
