#ifndef _DEMO_START_CROSS_PARK_FILTER_CLASS_HEADER_
#define _DEMO_START_CROSS_PARK_FILTER_CLASS_HEADER_

#define OID_ADTF_DEMO_START_CROSS_PARK "adtf.example.startcrosspark"

class ccrossParkInit : public cFilter
{
        ADTF_FILTER(OID_ADTF_DEMO_START_CROSS_PARK, "cross Parking", OBJCAT_DataFilter)  
public:

    ccrossParkInit(const tChar* __info);
    virtual ~ccrossParkInit();
...
protected:
	...
	cObjectPtr<IMediaTypeDescription>    m_pCoderDescSignalJuryID;
...
//control flags
	...
	tFloat32 distance_desired21;
	tFloat32 distance_desired22;
